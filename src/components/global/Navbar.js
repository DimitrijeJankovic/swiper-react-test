				...
				<div className="nav-bar">
					...
					<div className="nav-menu-links col-lg-4">
						...
						<nav className={this.state.toggleMenu ? "menu-links menu-links-mob" : "menu-links"}>
							<ul>
								<li onClick = {this.closeNavbar} className="m-b-5"><Link to={"/main"}>Home</Link></li>
								<li onClick = {this.closeNavbar} className="m-b-10"><Link to={"/main/gallery"}>Gallery</Link></li>
								<li onClick = {this.closeNavbar} className="m-b-15"><Link to={"/main/about"}>About</Link></li>
								<li onClick = {this.closeNavbar} className="m-b-20"><Link to={"/main/contact"}>Contact</Link></li>
							</ul>
						</nav>
					</div>
				</div>
